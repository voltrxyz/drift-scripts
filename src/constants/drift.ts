...
export const DISCRIMINATOR = {
  ...
  DEPOSIT_EARN: [22, 219, 117, 134, 59, 142, 142, 178],
  DEPOSIT_USER: [162, 73, 130, 153, 234, 34, 17, 56],
  DEPOSIT_USER_CURVE: [19, 116, 59, 156, 85, 142, 209, 121],
  DEPOSIT_VAULT: [126, 224, 21, 255, 228, 53, 117, 33],
  DEPOSIT_EARN_ZEROED: [145, 40, 166, 174, 236, 232, 41, 2],
  DEPOSIT_USER_ZEROED: [113, 215, 23, 59, 153, 36, 42, 172],
  DEPOSIT_USER_CURVE_ZEROED: [10, 92, 211, 234, 28, 153, 121, 179],
  DEPOSIT_VAULT_ZEROED: [77, 92, 116, 180, 212, 162, 95, 248],
  HARVEST_USER_CURVE: [228, 224, 21, 18, 188, 77, 139, 53],
  INITIALIZE_EARN: [152, 254, 77, 125, 32, 244, 220, 149],
  ...
  SEED_USER_CURVE: [119, 136, 97, 212, 230, 218, 191, 67],
  WITHDRAW_EARN: [70, 218, 208, 97, 147, 24, 19, 169],
  WITHDRAW_USER: [86, 169, 152, 107, 33, 180, 134, 115],
  WITHDRAW_USER_CURVE: [201, 56, 194, 89, 104, 154, 119, 205],
